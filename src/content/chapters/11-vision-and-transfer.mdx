---
title: "Pictures: convolutions and borrowed weights"
blurb: "Why the network from chapter eight is the wrong tool for photographs, what a convolution assumes, and how to train a good classifier on 200 pictures."
order: 11
day: 11
part: frontier
minutes: 100
...
A photograph is just numbers, so the network from chapter 8 can happily take
one as input.

It shouldn't, and the reason is worth getting exactly right, because the same
reasoning produces every remaining design in this book. Understand it once here
and chapters 12, 13 and 14 will read as variations rather than surprises.
...
sharpen, horizontal edges, whatever you like. And the useful part: *learning the
...
And that caveat is the interesting part. A ViT has **no built-in
...
Question 2 is the one worth sitting with, because it's the whole chapter in
miniature.
