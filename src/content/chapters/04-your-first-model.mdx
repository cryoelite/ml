...
blurb: "A straight line fitted by hand, a way of measuring how wrong it is, and the realisation that finding good numbers is a search."
order: 4
day: 4
part: foundations
minutes: 90
...
Today you write a model yourself, with no library doing anything on your
behalf.

It's about twenty lines, and it fits a straight line through some dots. That
sounds small. But every neural network in the rest of this book, including the
ones with billions of numbers in them, is a stack of exactly this thing repeated.
...
That distinction runs through everything here, so plainly: **training
...
noise, and the noise is really in the data. The best possible line through
...
Here's something I find satisfying. MSE and cross-entropy look like two
