---
title: "Putting it out into the world, and reading papers"
blurb: "Why accuracy is usually the wrong number, what a threshold really is, how a model goes stale, and how to get the gist of a paper in fifteen minutes."
order: 16
day: 14
part: practice
minutes: 90
...
Last day, and two things left. Knowing which number to report — because
"accuracy" is usually the wrong one — and being able to carry on learning after
this site runs out, without anybody writing you a syllabus.

Both today, and then you're done.
...
best-spent half hour in most machine learning projects.
...
been quietly wrong for three months.
...
hard problem, not a tidiness issue. The usual mitigation is to hold out
...
You now have enough to get the gist of most machine learning papers. —
...
which makes the two complementary rather than redundant. You'll get
