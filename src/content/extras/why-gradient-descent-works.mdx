...
blurb: "A neural network's loss surface has astronomically many minima and gradient descent is a greedy local method. By every classical argument it should fail. It doesn't, and the reasons are genuinely surprising."
order: 12
minutes: 15
kind: "theory"
