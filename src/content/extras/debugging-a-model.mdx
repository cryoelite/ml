...
That's a unfamiliar debugging situation for most engineers, and the
...
- **Fine, but the loss won't move** → the learning rate is too small, or you're at
  a flat spot. Try 10× larger before anything more exotic.
...
Chapter 6's baseline, used as a debugging tool. It is surprising how often a
...
experience is demoralising in a way that makes people conclude they're
bad at this.
