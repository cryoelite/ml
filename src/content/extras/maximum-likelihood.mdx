...
In chapter 4 I showed you two loss functions and told you they both fall out of
maximum likelihood. Then I moved on, because it was day four and there was a
model to fit.

This is the fold I skipped. It's worth twenty minutes because it turns "here are
the losses people use" into "here is how you *derive* a loss," which is a genuinely
different capability — and it's the fastest way to make sense of half the
...
Here's the payoff, and it's the reason this derivation is worth your time.
...
because MSE genuinely believes such a value could not have been an accident.
...
Here's the actual capability this unlocks. Suppose you're predicting **counts** —
...
There's something I find genuinely satisfying about that. Three losses that look
