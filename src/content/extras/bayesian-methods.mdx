...
blurb: "The branch that lost the scaling race and is very much alive where data is scarce or being wrong is expensive. Its selling point is the one thing neural networks are worst at: knowing what they don't know."
order: 23
minutes: 13
kind: "sibling"
...
**It's a feature.** With 30 data points you genuinely do know things the data
...
I find that genuinely pleasing. The Bayesians and the practitioners were doing
...
The genuinely useful takeaway isn't "learn Bayesian statistics." It's:
