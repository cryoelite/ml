...
This is not a lecture and there is nothing to sign. It is a list
...
Not because of a policy. Because an aggregate number does not tell you
...
Here's a uncomfortable technical fact, and I'd rather you meet it here
...
If base rates differ between groups, you cannot satisfy all three at
...
4. **Keep a human in the loop for consequential decisions**, and design so the
   human decides. A screen with an accept button and a queue of 400 is
...
not a burden so much as a interesting part of the job.
</Aside>
