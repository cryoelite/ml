...
blurb: "Nobody writes a chapter about missing values and duplicated rows, and it is where most of the time on a real project goes. The part of the job that tutorials skip."
order: 30
minutes: 14
kind: "craft"
...
bug would have taught neither. But it does leave a false impression, so here
correct it plainly:
