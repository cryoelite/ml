...
<Aside type="key">
That third point is the one that makes RL genuinely harder, and it's worth
dwelling on.
...
<Aside type="warn">
Both fixes exist because bootstrapping plus function approximation is genuinely
unstable, in a way tabular Q-learning is not.
...
Introduction* is the standard text and genuinely readable. Spinning Up in Deep RL
